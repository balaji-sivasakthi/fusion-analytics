...
function SmallStats() {
    const SData = [
        { title: "Total Camera", icon: <FaStore size={32} color={"blue"} />, value: "12", path: '/' },
        { title: "Total Users", icon: <IoStorefrontOutline size={32} color={"green"} />, value: "22", path: '/' },
        { title: "Total Vechicle", icon: <MdStore size={32} color={"red"} />, value: "22", path: '/' },
    ]
